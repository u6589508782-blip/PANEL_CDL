...
(() => {
  ...
  function viewUrlFor(page) {
    // URL absoluta robusta (GitHub Pages + iOS PWA).
    // Problema real: a veces la app se abre como "/REPO" (sin la "/" final).
    // En ese caso, un relative URL tipo "views/x.html" se resuelve como "/views/x.html"
    // (pierde el subdirectorio del repo) y da 404 -> "Load failed".
