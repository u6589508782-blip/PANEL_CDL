/* CDL · PWA Service Worker — v21  ha(scope-aware + precache ajustado) */
const SW_VERSION = 'v21';
const CACHE_STATIC = `cdl-static-${SW_VERSION}`;
const CACHE_PAGES  = `cdl-pages-${SW_VERSION}`;

/* Precache SOLO de ficheros que están en la raíz según tu captura */
const CORE_ASSETS = [
  './',
  './index.html',
  './offline.html',
  ...
  // Branding/UI que existen
  './logo-cdl.png',
  './logo_mantenimiento.png',
  './angular.png',

  // Iconos habituales (presentes en la raíz)
...
/* Heurística de tus endpoints de Apps Script */
