/* CDL · PWA Service Worker — v27 (scope-aware + precache ajustado) */
...
const CORE_ASSETS = [
  ...
  // ✅ IMPORTANTÍSIMO: tu frontend real (para que no dependa solo de index.html)
  './indexactuslizado.html',
  './indexactuslizado_MOD.html',
